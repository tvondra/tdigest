...
-- one retains singleton centroids after final compaction, while the other two
-- merge input values.
INSERT INTO tdigest_monotonic_digests
SELECT 10, 'built from 51 distinct values, no centroid merging', tdigest((2 * i)::double precision, 10000)
